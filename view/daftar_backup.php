    ...
    <div class="row">
        <div class="content col-sm-8 col-md-9">
            ...
            <div class="box">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" id="uname" name="uname" placeholder="Username (ex: skripsi_2017)" minlength="4" required>
...
<?php
    if (isset($_POST['submit-daftar'])) {
        ...
        $query_id     = mysqli_query($koneksi,"select id_user from user order by id_user desc limit 1");
